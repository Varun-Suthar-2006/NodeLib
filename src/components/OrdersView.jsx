...
import { Receipt, CheckCircle, Package, ArrowRight, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="wrap" style={{ padding: '40px 0 70px' }}>
      <div className="section-head">
        <div>
          <div className="section-kicker">PURCHASE HISTORY & INVOICES</div>
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                          ...
                          <span style={{ fontSize: '11.5px', color: 'var(--text-muted)' }}>by {book.author}</span>
                        </div>
                      </div>
